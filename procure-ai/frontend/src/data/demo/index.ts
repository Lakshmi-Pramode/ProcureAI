...
export const demoTender: Tender = {
  ...
  title: 'Procurement of Enterprise Computing Equipment',
  department: 'Information Technology',
  organization: 'Chennai Petroleum Corporation Ltd (CPCL)',
  category: 'IT',
  submissionDeadline: '2026-10-15T17:00:00.000Z',
  description: 'Supply, installation, and commissioning of enterprise-grade computing equipment including servers, workstations, networking equipment, and associated software licenses for the CPCL Manali Refinery IT infrastructure modernization project.',
...
export const demoTenders: Tender[] = [
  ...
  {
    id: 'tender_002',
    tenderId: 'CPCL/CIVIL/2026/012',
    title: 'Annual Maintenance Contract for Office Buildings',
    department: 'Civil Engineering',
    organization: 'Chennai Petroleum Corporation Ltd (CPCL)',
    category: 'Services',
    submissionDeadline: '2026-11-01T17:00:00.000Z',
    description: 'Annual maintenance contract for civil and structural maintenance of office buildings at Manali Refinery complex.',
    status: 'published',
    documents: [],
    requirements: [],
    vendors: [],
  ...
  {
    id: 'tender_003',
    tenderId: 'CPCL/ELECT/2026/007',
    title: 'Procurement of Electrical Transformers',
    department: 'Electrical',
    organization: 'Chennai Petroleum Corporation Ltd (CPCL)',
    category: 'Goods',
    submissionDeadline: '2026-09-30T17:00:00.000Z',
    description: 'Procurement and installation of 3 x 5 MVA power transformers for the refinery expansion project.',
    status: 'draft',
    documents: [],
    requirements: [],
    vendors: [],
...
const vendorADocs: VendorDocument[] = [
  { id: 'vdoc_a1', vendorId: 'vendor_001', tenderId: 'tender_001', documentType: 'GST Certificate', fileName: 'ABC_GST_Certificate.pdf', fileSize: 524288, fileType: 'application/pdf', uploadedAt: ts(10, 0), status: 'ready', extractedData: makeExtracted({ gst_number: '33AABCA1234F1Z5', legal_name: 'ABC Technologies Pvt Ltd', status: 'Active', registration_date: '2018-04-15' }, 1, 98) },
  { id: 'vdoc_a2', vendorId: 'vendor_001', tenderId: 'tender_001', documentType: 'PAN Card', fileName: 'ABC_PAN.pdf', fileSize: 204800, fileType: 'application/pdf', uploadedAt: ts(10, 1), status: 'ready', extractedData: makeExtracted({ pan_number: 'AABCA1234F', name: 'ABC Technologies Pvt Ltd', type: 'Company' }, 1, 99) },
  ...
  { id: 'vdoc_a5', vendorId: 'vendor_001', tenderId: 'tender_001', documentType: 'MSME/Udyam Certificate', fileName: 'ABC_Udyam_Registration.pdf', fileSize: 307200, fileType: 'application/pdf', uploadedAt: ts(10, 4), status: 'ready', extractedData: makeExtracted({ udyam_number: 'UDYAM-TN-01-0012345', enterprise_name: 'ABC Technologies Pvt Ltd', category: 'Medium', date_of_registration: '2020-07-01' }, 1, 97) },
  { id: 'vdoc_a6', vendorId: 'vendor_001', tenderId: 'tender_001', documentType: 'Company Registration', fileName: 'ABC_Certificate_of_Incorporation.pdf', fileSize: 409600, fileType: 'application/pdf', uploadedAt: ts(10, 5), status: 'ready', extractedData: makeExtracted({ cin: 'U72200TN2016PTC123456', company_name: 'ABC Technologies Pvt Ltd', date_of_incorporation: '2016-06-15', type: 'Private Limited' }, 1, 99) },
  ...
  { id: 'vdoc_a11', vendorId: 'vendor_001', tenderId: 'tender_001', documentType: 'EPFO/ESIC Document', fileName: 'ABC_EPFO_Registration.pdf', fileSize: 307200, fileType: 'application/pdf', uploadedAt: ts(10, 10), status: 'ready', extractedData: makeExtracted({ epfo_number: 'TNMAS0012345000', establishment_name: 'ABC Technologies Pvt Ltd', status: 'Active' }, 1, 96) },
...
const vendorBDocs: VendorDocument[] = [
  { id: 'vdoc_b1', vendorId: 'vendor_002', tenderId: 'tender_001', documentType: 'GST Certificate', fileName: 'Bharat_GST_Certificate.pdf', fileSize: 512000, fileType: 'application/pdf', uploadedAt: ts(10, 30), status: 'ready', extractedData: makeExtracted({ gst_number: '29AABCB5678G1Z3', legal_name: 'Bharat Digital Systems LLP', status: 'Active', registration_date: '2019-08-20' }, 1, 97) },
  { id: 'vdoc_b2', vendorId: 'vendor_002', tenderId: 'tender_001', documentType: 'PAN Card', fileName: 'Bharat_PAN.pdf', fileSize: 204800, fileType: 'application/pdf', uploadedAt: ts(10, 31), status: 'ready', extractedData: makeExtracted({ pan_number: 'AABCB5678G', name: 'Bharat Digital Systems LLP', type: 'LLP' }, 1, 98) },
...
const vendorCDocs: VendorDocument[] = [
  { id: 'vdoc_c1', vendorId: 'vendor_003', tenderId: 'tender_001', documentType: 'GST Certificate', fileName: 'Nova_GST_Certificate.pdf', fileSize: 524288, fileType: 'application/pdf', uploadedAt: ts(11, 0), status: 'ready', extractedData: makeExtracted({ gst_number: '07AABCN9012H1Z7', legal_name: 'Nova Infotech Solutions Pvt Ltd', status: 'Active', registration_date: '2017-11-01' }, 1, 97) },
  { id: 'vdoc_c2', vendorId: 'vendor_003', tenderId: 'tender_001', documentType: 'PAN Card', fileName: 'Nova_PAN_Card.pdf', fileSize: 102400, fileType: 'application/pdf', uploadedAt: ts(11, 1), status: 'ready', extractedData: makeExtracted({ pan_number: 'AABCN9012H', name: 'Nova InfoTech Solutions Pvt. Ltd.', type: 'Company' }, 1, 88) },
  ...
  { id: 'vdoc_c5', vendorId: 'vendor_003', tenderId: 'tender_001', documentType: 'Company Registration', fileName: 'Nova_Certificate_of_Incorporation.pdf', fileSize: 409600, fileType: 'application/pdf', uploadedAt: ts(11, 4), status: 'ready', extractedData: makeExtracted({ cin: 'U72900DL2015PTC234567', company_name: 'Nova Infotech Solutions Pvt Ltd', date_of_incorporation: '2015-03-20', type: 'Private Limited' }, 1, 99) },
  ...
  { id: 'vdoc_c8', vendorId: 'vendor_003', tenderId: 'tender_001', documentType: 'MSME/Udyam Certificate', fileName: 'Nova_Udyam_Certificate.pdf', fileSize: 307200, fileType: 'application/pdf', uploadedAt: ts(11, 7), status: 'ready', extractedData: makeExtracted({ udyam_number: 'UDYAM-DL-07-0098765', enterprise_name: 'Nova InfoTech Solutions Pvt. Ltd.', category: 'Small', date_of_registration: '2021-02-15' }, 1, 89) },
  ...
  { id: 'vdoc_c10', vendorId: 'vendor_003', tenderId: 'tender_001', documentType: 'Startup Certificate', fileName: 'Nova_Startup_India_Certificate.pdf', fileSize: 409600, fileType: 'application/pdf', uploadedAt: ts(11, 9), status: 'ready', extractedData: makeExtracted({ certificate_number: 'DIPP12345', company_name: 'Nova Infotech Solutions Pvt Ltd', recognition_date: '2019-06-15', valid_until: '2029-06-15' }, 1, 96) },
];
...
export const demoVendors: Vendor[] = [
  {
    ...
    email: 'amit.patel@abctech.co.in',
    phone: '+91-44-2345-6789',
    address: '42, IT Park, Sholinganallur, Chennai 600119',
    registrationNumber: 'U72200TN2016PTC123456',
  ...
  },
  {
    ...
    email: 'sunita@bharatdigital.in',
    phone: '+91-80-4567-8901',
    address: '15, Electronic City Phase 2, Bengaluru 560100',
    registrationNumber: 'AAQ-1234',
    gstNumber: '29AABCB5678G1Z3',
    panNumber: 'AABCB5678G',
    tenderIds: ['tender_001'],
  ...
  },
  {
    ...
    name: 'Nova Infotech Solutions',
    contactPerson: 'Vikram Singh',
    email: 'vikram.singh@novainfotech.com',
    phone: '+91-11-2345-0123',
    address: '201, Nehru Place, New Delhi 110019',
    registrationNumber: 'U72900DL2015PTC234567',
    gstNumber: '07AABCN9012H1Z7',
    panNumber: 'AABCN9012H',
    tenderIds: ['tender_001'],
...
export const demoComplianceVendorA: ComplianceResult[] = [
  cr(1, 'vendor_001', 'req_001', 'compliant', 98, 'GST: 33AABCA1234F1Z5 — Active', 'Must have active GST registration', 'GST registration 33AABCA1234F1Z5 is active and valid. The legal name matches the bidder entity.', 'ABC_GST_Certificate.pdf', 1, 'GSTIN: 33AABCA1234F1Z5\nLegal Name: ABC Technologies Pvt Ltd\nStatus: Active'),
  cr(2, 'vendor_001', 'req_002', 'compliant', 99, 'PAN: AABCA1234F', 'Valid PAN required', 'PAN card AABCA1234F is valid. The name on the PAN matches the bidding entity name.', 'ABC_PAN.pdf', 1, 'Permanent Account Number: AABCA1234F\nName: ABC Technologies Pvt Ltd'),
  ...
  cr(7, 'vendor_001', 'req_007', 'compliant', 99, 'CIN: U72200TN2016PTC123456', 'Must be registered under Companies Act or equivalent', 'Certificate of Incorporation found. Company registered under Companies Act 2013 as a Private Limited company.', 'ABC_Certificate_of_Incorporation.pdf', 1, 'CIN: U72200TN2016PTC123456\nDate of Incorporation: 15-06-2016'),
...
export const demoComplianceVendorB: ComplianceResult[] = [
  cr(1, 'vendor_002', 'req_001', 'compliant', 97, 'GST: 29AABCB5678G1Z3 — Active', 'Must have active GST registration', 'GST registration is active and valid.', 'Bharat_GST_Certificate.pdf', 1, 'GSTIN: 29AABCB5678G1Z3\nStatus: Active'),
  cr(2, 'vendor_002', 'req_002', 'compliant', 98, 'PAN: AABCB5678G', 'Valid PAN required', 'PAN card is valid and matches the bidding entity.', 'Bharat_PAN.pdf', 1, 'PAN: AABCB5678G\nName: Bharat Digital Systems LLP'),
  ...
  cr(7, 'vendor_002', 'req_007', 'compliant', 98, 'LLP Registration: AAQ-1234', 'Must be registered under Companies Act or equivalent', 'LLP registration document found. Bharat Digital Systems LLP is a registered Limited Liability Partnership.', 'Bharat_LLP_Registration.pdf', 1, 'LLPIN: AAQ-1234\nDate: 12-03-2020'),
...
export const demoComplianceVendorC: ComplianceResult[] = [
  cr(1, 'vendor_003', 'req_001', 'compliant', 97, 'GST: 07AABCN9012H1Z7 — Active', 'Must have active GST registration', 'GST registration is active and valid.', 'Nova_GST_Certificate.pdf', 1, 'GSTIN: 07AABCN9012H1Z7\nStatus: Active'),
  cr(2, 'vendor_003', 'req_002', 'manual_review', 72, 'PAN: AABCN9012H — Name variation detected', 'Valid PAN required', 'PAN card found but the name on PAN reads "Nova InfoTech Solutions Pvt. Ltd." while other documents show "Nova Infotech Solutions Pvt Ltd". Minor name variation detected — manual verification recommended.', 'Nova_PAN_Card.pdf', 1, 'PAN: AABCN9012H\nName: Nova InfoTech Solutions Pvt. Ltd.'),
  ...
  cr(5, 'vendor_003', 'req_005', 'manual_review', 74, 'UDYAM-DL-07-0098765 — Name variation', 'If applicable, valid MSME/Udyam registration', 'Udyam certificate found but the name reads "Nova InfoTech Solutions Pvt. Ltd." which has minor differences from the company registration name. Manual verification recommended.', 'Nova_Udyam_Certificate.pdf', 1, 'Udyam Number: UDYAM-DL-07-0098765\nName: Nova InfoTech Solutions Pvt. Ltd.'),
  ...
  cr(7, 'vendor_003', 'req_007', 'compliant', 99, 'CIN: U72900DL2015PTC234567', 'Must be registered under Companies Act or equivalent', 'Certificate of Incorporation verified. Registered under Companies Act 2013.', 'Nova_Certificate_of_Incorporation.pdf', 1, 'CIN: U72900DL2015PTC234567'),
...
export const demoRiskAssessments: Record<string, RiskAssessment> = {
  ...
  vendor_002: {
    ...
    inconsistencies: [
      { id: 'inc_b1', type: 'name_mismatch', severity: 'low', description: 'Entity type mismatch between documents', document1: 'GST Certificate', document2: 'PAN Card', value1: 'Bharat Digital Systems LLP', value2: 'Bharat Digital Systems LLP', field: 'Entity Name' },
    ],
    calculatedAt: ts(12, 0),
  },
  vendor_003: {
    ...
    inconsistencies: [
      { id: 'inc_c1', type: 'name_mismatch', severity: 'medium', description: 'Company name variation between PAN and Company Registration', document1: 'Nova_PAN_Card.pdf', document2: 'Nova_Certificate_of_Incorporation.pdf', value1: 'Nova InfoTech Solutions Pvt. Ltd.', value2: 'Nova Infotech Solutions Pvt Ltd', field: 'Company Name' },
      { id: 'inc_c2', type: 'name_mismatch', severity: 'medium', description: 'Company name variation between Udyam and Company Registration', document1: 'Nova_Udyam_Certificate.pdf', document2: 'Nova_Certificate_of_Incorporation.pdf', value1: 'Nova InfoTech Solutions Pvt. Ltd.', value2: 'Nova Infotech Solutions Pvt Ltd', field: 'Company Name' },
    ],
    calculatedAt: ts(12, 0),
  },
};
...
export const demoAuditTrail: AuditEntry[] = [
  { id: 'aud_01', userId: 'user_001', userName: 'Rajesh Kumar', action: 'tender_created', timestamp: ts(8, 0), tenderId: 'tender_001', tenderTitle: 'Procurement of Enterprise Computing Equipment', details: 'Created tender CPCL/IT/2026/001' },
  { id: 'aud_02', userId: 'user_001', userName: 'Rajesh Kumar', action: 'document_uploaded', timestamp: ts(8, 30), tenderId: 'tender_001', tenderTitle: 'Procurement of Enterprise Computing Equipment', documentName: 'CPCL_IT_2026_001_Tender_Document.pdf', details: 'Uploaded tender document (2.4 MB)' },
  { id: 'aud_03', userId: 'user_001', userName: 'Rajesh Kumar', action: 'ai_analysis_started', timestamp: ts(9, 0), tenderId: 'tender_001', tenderTitle: 'Procurement of Enterprise Computing Equipment', details: 'Started AI analysis of tender document' },
  { id: 'aud_04', userId: 'system', userName: 'AI Engine', action: 'ai_analysis_completed', timestamp: ts(9, 5), tenderId: 'tender_001', tenderTitle: 'Procurement of Enterprise Computing Equipment', details: 'AI analysis completed — 15 requirements extracted' },
  { id: 'aud_05', userId: 'user_001', userName: 'Rajesh Kumar', action: 'requirement_edited', timestamp: ts(9, 10), tenderId: 'tender_001', tenderTitle: 'Procurement of Enterprise Computing Equipment', details: 'Modified requirement R003: Updated condition to "≥ ₹10 Crore in last 3 financial years"' },
  { id: 'aud_06', userId: 'user_001', userName: 'Rajesh Kumar', action: 'vendor_added', timestamp: ts(9, 30), tenderId: 'tender_001', vendorId: 'vendor_001', vendorName: 'ABC Technologies Pvt Ltd', details: 'Added vendor ABC Technologies Pvt Ltd (VND-2026-001)' },
  { id: 'aud_07', userId: 'user_001', userName: 'Rajesh Kumar', action: 'vendor_added', timestamp: ts(9, 45), tenderId: 'tender_001', vendorId: 'vendor_002', vendorName: 'Bharat Digital Systems', details: 'Added vendor Bharat Digital Systems (VND-2026-002)' },
  { id: 'aud_08', userId: 'user_001', userName: 'Rajesh Kumar', action: 'vendor_added', timestamp: ts(10, 0), tenderId: 'tender_001', vendorId: 'vendor_003', vendorName: 'Nova Infotech Solutions', details: 'Added vendor Nova Infotech Solutions (VND-2026-003)' },
  { id: 'aud_09', userId: 'user_001', userName: 'Rajesh Kumar', action: 'vendor_document_uploaded', timestamp: ts(10, 0), vendorId: 'vendor_001', vendorName: 'ABC Technologies Pvt Ltd', details: 'Uploaded 12 documents for ABC Technologies Pvt Ltd' },
  { id: 'aud_10', userId: 'user_001', userName: 'Rajesh Kumar', action: 'vendor_document_uploaded', timestamp: ts(10, 30), vendorId: 'vendor_002', vendorName: 'Bharat Digital Systems', details: 'Uploaded 8 documents for Bharat Digital Systems' },
  { id: 'aud_11', userId: 'user_001', userName: 'Rajesh Kumar', action: 'vendor_document_uploaded', timestamp: ts(11, 0), vendorId: 'vendor_003', vendorName: 'Nova Infotech Solutions', details: 'Uploaded 10 documents for Nova Infotech Solutions' },
  ...
  { id: 'aud_13', userId: 'system', userName: 'AI Engine', action: 'compliance_check_completed', timestamp: ts(11, 30), tenderId: 'tender_001', vendorId: 'vendor_001', vendorName: 'ABC Technologies Pvt Ltd', details: 'Compliance check completed — 15/15 compliant (97% score)' },
  { id: 'aud_14', userId: 'system', userName: 'AI Engine', action: 'compliance_check_completed', timestamp: ts(11, 32), tenderId: 'tender_001', vendorId: 'vendor_002', vendorName: 'Bharat Digital Systems', details: 'Compliance check completed — 4/15 compliant, 7 non-compliant, 4 manual review (40% score)' },
  { id: 'aud_15', userId: 'system', userName: 'AI Engine', action: 'compliance_check_completed', timestamp: ts(11, 34), tenderId: 'tender_001', vendorId: 'vendor_003', vendorName: 'Nova Infotech Solutions', details: 'Compliance check completed — 8/15 compliant, 2 non-compliant, 5 manual review (73% score)' },
  ...
  { id: 'aud_17', userId: 'user_001', userName: 'Rajesh Kumar', action: 'compliance_result_reviewed', timestamp: ts(12, 15), tenderId: 'tender_001', vendorId: 'vendor_001', vendorName: 'ABC Technologies Pvt Ltd', details: 'Reviewed all compliance results for ABC Technologies — approved' },
