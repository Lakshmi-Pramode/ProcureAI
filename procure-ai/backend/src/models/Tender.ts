...
import type { Tender as ITender } from '../types/index.js';

export interface TenderDoc extends Omit<ITender, 'id'>, Document {}
...
export const TenderModel = mongoose.model<TenderDoc>('Tender', TenderSchema);
